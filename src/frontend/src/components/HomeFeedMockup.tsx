import { Armchair, Bike, MapPin, Smartphone, Zap } from "lucide-react";
import type { SampleListing } from "../types/blueprint";
      ...
      {listings.map((listing) => {
        ...
        return (
          ...
          >
            {/* Image placeholder */}
            <div
              className={`${listing.imagePlaceholder} h-28 flex items-center justify-center relative`}
            >
            ...
            <div className="p-3 flex flex-col gap-1.5 flex-1">
              ...
              <div className="flex items-center gap-1 mt-auto">
                ...
                <span className="text-xs font-body text-muted-foreground ml-auto flex-shrink-0">
                  {listing.distance}km
                </span>
              </div>
            </div>
