...
import type { ExternalBlob, ListingId } from "../backend";
...
const REAL_ESTATE_SUBCATEGORIES: {
  label: string;
  value: RealEstateSubCategory;
}[] = [
  {
  ...
  },
  {
    ...
    value: RealEstateSubCategory.apartmentsAndFlats,
  },
  ...
  {
    label: "Short-Let / Holiday Rentals",
...
function EditListingForm({ listingId, onSuccess, onCancel }: EditListingProps) {
  ...
  useEffect(() => {
    if (listing && !initialized) {
      ...
      setSubCategory(
        (listing.subCategory as RealEstateSubCategory | undefined) ?? "",
      );
      ...
      setPropertySize(
        listing.propertySize ? Number(listing.propertySize).toString() : "",
      );
      setNumBedrooms(
        listing.numBedrooms ? Number(listing.numBedrooms).toString() : "",
      );
  ...
  return (
    <div className="flex flex-col">
      ...
      <form
        ...
        className="flex flex-col gap-5 px-4 py-5 max-w-2xl mx-auto w-full"
      >
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="edit-title" className="font-body font-medium">
            Title *
          </Label>
          <Input
            id="edit-title"
          ...
          />
          {errors.title && (
            <p className="text-xs text-destructive font-body">{errors.title}</p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          >
            <SelectTrigger
              className={`h-12 text-base ${errors.category ? "border-destructive" : ""}`}
            >
        ...
        {isRealEstate && (
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              value={subCategory}
              onValueChange={(v) => setSubCategory(v as RealEstateSubCategory)}
            >
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="edit-price" className="font-body font-medium">
            Price (GMD) *
          </Label>
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 font-display font-bold text-primary">
              D
            </span>
            <Input
              id="edit-price"
          ...
          {errors.price && (
            <p className="text-xs text-destructive font-body">{errors.price}</p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="edit-location" className="font-body font-medium">
            Location *
          </Label>
          <Input
            id="edit-location"
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="edit-description" className="font-body font-medium">
            Description
          </Label>
          <Textarea
            id="edit-description"
