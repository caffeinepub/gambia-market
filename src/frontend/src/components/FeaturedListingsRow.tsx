...
export default function FeaturedListingsRow({
  listings,
  onListingClick,
    ...
    <section className="px-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span
            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold font-body text-accent-foreground"
            style={{ background: "var(--accent)" }}
          >
        ...
        <button
          type="button"
          className="flex items-center gap-1 text-xs font-body font-medium text-primary hover:text-primary/80 transition-colors"
        >
            ...
            >
              <div className="relative h-28 bg-muted overflow-hidden">
                ...
                <div className="absolute top-1.5 left-1.5">
                  <span
                    className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md text-[9px] font-bold font-body text-accent-foreground"
                    style={{ background: "var(--accent)" }}
                  >
